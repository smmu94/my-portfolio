...
export default function Page() {
  return (
    <div className="flex flex-col items-center justify-center h-full p-2 gap-4 lg:flex-row lg:w-2/3 mx-auto">
      <Image
        ...
        priority
      />
      <div className="text-center text-light p-4 md:p-8 lg:p-0">
